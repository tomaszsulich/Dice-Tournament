...
| Czy system sugeruje,<br>co wybrać? | Nie. Pokazuje jedynie dostępność pól we wspólnym formularzu.<br>Nie rekomenduje kategorii ani zatrzymań.<br>Przed wyborem nie pokazuje prawdopodobieństw ani prognozowanej punktacji. |
