...
| Kiedy i do jakiej historii<br>uczestnik ma dostęp? | W trakcie rozgrywki widzi wspólny formularz i bieżący stan, ale nie szczegółową historię rzutów. Po zakończeniu turnieju widzi wyłącznie własną historię. Nigdy nie otrzymuje szczegółowej historii innych uczestników. Organizator widzi historię nadzorowanego turnieju. |
