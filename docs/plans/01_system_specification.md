...
| Pytanie | Decyzja |
| --- | --- |
| Czy kolejne rundy eliminują uczestników? | W fazie grupowej nie. Wyniki są sumowane i budują ranking. Eliminacje rozpoczynają się dopiero w fazie pucharowej;<br>zwycięzcy ćwierćfinałów przechodzą do półfinałów itd. |
