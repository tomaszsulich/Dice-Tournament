...
| Czy spotkania wewnątrz drużyny<br>są bezwzględnie zakazane?<br>Czy powtórne spotkania<br>również są wykluczone? | Nie, ponieważ dla części składów byłoby to matematycznie niewykonalne.<br>Oba warunki są ograniczeniami preferowanymi o wysokiej wadze.<br>System minimalizuje liczbę naruszeń.<br>Informację o nich pokazuje organizatorowi. |
