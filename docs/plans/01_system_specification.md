...
| Co dzieje się po etapie<br>ze wspólnym formularzem? | Przestaje być dostępny dla uczestników, ale nie znika z systemu.<br>Dla organizatora staje się nieedytowalnym widokiem historycznym.<br>Organizator może wybrać rundę, stół i rozgrywkę, a następnie zobaczyć końcowy formularz.<br>Może również odtworzyć jego zmiany krok po kroku.Dostęp zachowuje po zakończeniu turnieju.<br>Do tego czasu uczestnik nie może otworzyć ani cudzej, ani własnej historii rzutów. |
