...
| Czy następna runda<br>czeka na wszystkie stoły,<br>czy synchronizacja następuje dopiero między etapami? | Przy obecnej zasadzie ponownego układania grup według aktualnego rankingu<br>następna runda grupowa musi czekać na zakończenie wszystkich stołów bieżącej rundy.<br>Wariant oczekiwania wyłącznie przed następnym etapem wymagałby ustalenia wszystkich grup<br>z góry albo pozostawienia grup bez zmian, dlatego nie został wybrany.<br>Stoły działają równolegle i nie czekają na siebie między turami. |
